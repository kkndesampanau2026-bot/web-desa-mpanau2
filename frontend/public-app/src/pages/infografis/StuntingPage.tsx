...
import { useInfografisStunting } from '@/lib/queries'
 ...
 * dan endpoint sumbernya memang tidak menyimpannya.
 */
export function StuntingPage() {
  const { data, isPending, error } = useInfografisStunting()
    ...
    >
      {data && (
        <div className="mx-auto max-w-5xl px-6 py-10">
          <h1 className="font-heading text-2xl font-bold text-navy">Data Stunting</h1>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-navy/10 text-left text-slate-500">
                      <th scope="col" className="py-2 font-medium">Dusun</th>
                      <th scope="col" className="py-2 text-right font-medium">Balita Diukur</th>
                      <th scope="col" className="py-2 text-right font-medium">Kasus</th>
                      <th scope="col" className="py-2 text-right font-medium">Prevalensi</th>
                    </tr>
                  </thead>
                  <tbody>
