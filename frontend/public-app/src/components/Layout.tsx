...
import { WidgetStatistik } from './WidgetStatistik'
                ...
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `block rounded-lg px-4 py-3 text-sm font-semibold transition ${
                      isActive ? 'bg-white/10 text-gold' : 'text-white/85 hover:bg-white/5'
                    }`
                  }
                >
                  {menu.label}
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2 text-sm">
                {[
                  ...
                  <li key={ke}>
                    <NavLink to={ke} className="underline-offset-4 hover:text-gold hover:underline">
                      {label}
                    </NavLink>
                  </li>
                ))}
