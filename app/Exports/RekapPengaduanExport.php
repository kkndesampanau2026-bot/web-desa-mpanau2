 ...
 *
 * Lampiran TIDAK ikut. Rekap ini sengaja berisi teks saja; berkas yang
 * diunggah warga dibuka lewat layar Pengaduan pada dashboard, tempat setiap
 * pembukaannya tercatat satu per satu.
 *
 ...
 */
class RekapPengaduanExport extends StringValueBinder implements FromQuery, WithCustomValueBinder, WithHeadings, WithMapping, WithStyles, WithTitle
{
    use Exportable;
