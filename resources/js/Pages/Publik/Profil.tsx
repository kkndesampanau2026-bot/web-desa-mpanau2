 ...
 * Profil Desa — PRD 6.1.
 *
 * Tidak ada lagi keadaan "memuat" maupun "gagal memuat" di sini: data tiba
 * bersama halaman, jadi yang tersisa hanyalah kemungkinan admin desa belum
 * mengisinya. Itulah sebabnya pembungkus `StatusMuat` yang lama tidak ikut
 * berpindah — dua dari tiga keadaannya sudah tidak mungkin terjadi.
 */
  ...
  if (!profil) {
    return (
      <>
        ...
        <EmptyState eyebrow="Tentang Desa" judul="Profil Desa" deskripsi={DESKRIPSI} />
      </>
    )
  }
            ...
            <Kartu className="p-6">
              ...
              <dl className="space-y-2 text-sm">
                {(
                  ...
                  <div
                    key={arah}
                    className="flex justify-between gap-4 border-b border-navy/5 pb-2 last:border-0"
                  >
